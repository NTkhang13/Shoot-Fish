window.addEventListener('load', function(){
    ...
    class Particle{
        constructor(game, x, y){
            ...
            this.boundced = 0;
            this.bottomBoundceBoundary = Math.random() * 80 + 60;
        }
        update(){
            this.angle += this.va;
            ...
            if( this.y > this.game.height - this.bottomBoundceBoundary && this.boundced < 5){
                this.boundced++;
                this.speedY *= -0.7;
            }
        }
    ...
    class Enemy{
        ...
        update(){
            this.x += this.speedX - this.game.speed;
            if(this.x + this.y < 0) this.markedForDeletion = true;
            //
            if(this.frameX < this.maxFrame){
                this.frameX++;
            } else this.frameX = 0;
    ...
    class UI{
        ...
        draw(context){
            ...
            if (this.game.score > this.game.winingScore){
                    ...
                    messager1 = 'You Lose';
                    messager2 = 'Try again next time!';
                }
                context.font = '50px ' + this.fontFamily;
                context.fillText(messager1, this.game.width * 0.5, this.game.height * 0.5 - 40);
                context.font = '25px ' + this.fontFamily;
                context.fillText(messager2, this.game.width * 0.5, this.game.height * 0.5 + 40);
            }
            context.restore();
    ...
    class Game{
        ...
        addEnemy(){
            ...
            if(randomize < 0.3) this.enemies.push(new Argler1(this));
            else if(randomize < 0.6) this.enemies.push(new Argler2(this));
